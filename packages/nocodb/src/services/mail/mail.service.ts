    ...
    try {
      switch (mailEvent) {
        ...
        case MailEvent.WELCOME: {
          ...
          await mailerAdapter.mailSend({
            to: user.email,
            subject: 'Welcome to Social Pixl!',
        ...
        case MailEvent.ORGANIZATION_INVITE: {
          ...
          await mailerAdapter.mailSend({
            to: user.email,
            subject: 'You have been invited to join Social Pixl',
        ...
        case MailEvent.ORGANIZATION_ROLE_UPDATE: {
          ...
          await mailerAdapter.mailSend({
            to: user.email,
            subject: 'Role updated in Social Pixl',
        ...
        case MailEvent.FORM_SUBMISSION:
          {
            ...
            await mailerAdapter.mailSend({
              to: emails.join(','),
              subject: `Social Pixl Forms: Someone has responded to ${formView.title}`,

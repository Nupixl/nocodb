...
<template>
  ...
  >
    <a
      v-e="['c:branding:join-cloud']"
      class="flex flex-grow !no-underline items-center justify-center border-r-1 h-full hover:bg-nc-bg-gray-light"
      href="https://app.nupixl.com/#/signin?utm_source=OSS&utm_medium=OSS&utm_campaign=OSS&utm_content=OSS"
    >
      <div class="px-1 text-nc-content-gray-muted prose-sm" style="line-height: 1.3125rem">Try Nupixl Cloud</div>
    </a>
        ...
        <div class="w-70.5 bg-transparent overflow-hidden rounded-2xl shadow border-1 border-nc-border-gray-medium">
          <div class="p-4 bg-nc-bg-default gap-4 inline-flex flex-col w-full">
            <div class="flex items-center gap-3">
              <div class="text-base text-nc-content-gray-emphasis font-bold flex-1">Nupixl Cloud</div>
            ...
            <div class="flex flex-col gap-2">
              ...
              <a href="https://app.nupixl.com/#/signin" target="_blank" class="!no-underline" rel="noopener">

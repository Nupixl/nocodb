  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        // Open Graph
        { hid: 'og:site_name', property: 'og:site_name', content: 'Social Pixl' },
        { hid: 'og:type', property: 'og:type', content: 'website' },
        { hid: 'og:title', property: 'og:title', content: 'Social Pixl' },
        {
          hid: 'og:description',
          property: 'og:description',
          content:
            'Social Pixl provides an intuitive spreadsheet interface for creating online databases, either from scratch or by connecting to any Postgres/MySQL. Access your data through interactive UIs or via API and SQL. Get started for free.',
        },
        { hid: 'og:url', property: 'og:url', content: 'https://socialpixl.com' },
        // Twitter
        { hid: 'twitter:card', name: 'twitter:card', content: 'summary_large_image' },
        { hid: 'twitter:title', name: 'twitter:title', content: 'Social Pixl' },
        {
